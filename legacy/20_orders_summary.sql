...
CREATE OR REPLACE TABLE JAFFLE_LEGACY_DB.PUBLIC.ORDERS_SUMMARY AS
WITH
ORDER_ITEMS_SUMMARY AS (
    ...
    FROM JAFFLE_LEGACY_DB.PUBLIC.ORDER_ITEMS_ENRICHED
    GROUP BY ORDER_ID
)
SELECT
    O.ORDER_ID,
...
FROM JAFFLE_LEGACY_DB.PUBLIC.STG_ORDERS O
