...
CREATE OR REPLACE TABLE JAFFLE_LEGACY_DB.PUBLIC.CUSTOMERS_SUMMARY AS
WITH
CUSTOMER_ORDERS_SUMMARY AS (
    ...
    FROM JAFFLE_LEGACY_DB.PUBLIC.ORDERS_SUMMARY
...
FROM JAFFLE_LEGACY_DB.PUBLIC.STG_CUSTOMERS C
